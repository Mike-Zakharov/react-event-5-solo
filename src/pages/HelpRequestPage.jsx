...
const HelpRequestPage = () => {
  ...
  const actionStep = data.actionsSchedule.map(step => {
    return (
      <Grid2 size={12}>
        <Typography >
          {step.isDone ? <CheckCircleOutlineIcon color='success' sx={{mr:'4px'}}/> : <CheckCircleOutlineIcon color='disabled' sx={{mr:'4px', verticalAlign:'middle',width:"24px",height:"24px"}}/>}{step.stepLabel}
        </Typography>
      </Grid2>
    )
  })
    ...
    <>
      {itemId ?
        <Paper sx={{p: '30px 40px 64px 40px'}}>
          ...
          <Paper sx={{display:'flex', justifyContent:'space-between',alignItems:'start', mt: '30px', width:'1080px', p:'40px 36px'}}>
            <Grid2 container rowSpacing='30px' sx={{width:'550px'}}> 
              ...
              <Grid2 size={12}>
                ...
                >
                  ...
                  {data.organization.isVerified &&
                    <Typography>
                      <VerifiedIcon color='success' sx={{mr:'4px',width:"20px",height:"20px", verticalAlign:'middle'}}/>Организация проверена
                    </Typography>
                  }
              </Grid2>
              <Grid2 size={12}>
              ...
              <Grid2 size={12}>
                ...
                <Grid2 container size={12} columnSpacing={5} sx={{mt:'10px'}}>
                  ...
                  <Grid2 size={3}>
                    <Typography sx={{mb:'4px', fontWeight:'500'}}>
                    Телефон
                    </Typography>
                    {data.contacts.phone}
                  </Grid2>
            ...
            <Button variant='outlined' sx={{p:'4px 10px', color:'black'}} >
              <StarOutlineIcon color={favoriterIconColor} sx={{mr:'8px',width:"18px",height:"18px",verticalAlign:'middle'}}/>
              В избранное
            </Button>
          </Paper>
        </Paper>  
